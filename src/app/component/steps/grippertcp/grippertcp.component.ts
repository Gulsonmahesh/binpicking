...
gripperTcpData(){
  const grippertcpdata = {admin_robot_id:1,admin_gripper_id:1,project_id:0,tcp_list:[1,2,3,4,5,6],invariance_axis:"False",invariance_lower_limit:0,invariance_upper_limit:0,stages_number:0,invariance_flag:"False"}
